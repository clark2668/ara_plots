...
def main():
	...
	ax_list = fig.axes
	for ax in ax_list:
		ax.set_xlim([start_year,2020.333]) #set the x limits of the plot
		ax.xaxis.set_ticks(np.array([2012,2013,2014,2015,2016,2017,2018,2019,2020]))
	...
	ax_a5.set_xticklabels(['2012','2013','2014','2015','2016','2017','2018','2019','2020'],size=11)

...
pa_data = np.genfromtxt("pa_eff_vs_energy.csv",delimiter=',',skip_header=1,names=['energy','eff'])
pa_energy = pa_data['energy']
pa_eff = pa_data['eff']
ax2.plot(pa_energy, pa_eff, '-.', color='red', label='Phased Array, 10 mo', linewidth=5)

...
def main():
	...
	ax.plot(SPIce[0],SPIce[1],"kx", label="SPIce",markersize=24, mew=8)
	
	print "SPIce to A2: ",np.sqrt(math.pow(SPIce[0]-A2[0],2.) + math.pow(SPIce[1]-A2[1],2.))
	...
	fig.savefig("ara-spice-icecube.pdf",edgecolor='none',bbox_inches="tight")
